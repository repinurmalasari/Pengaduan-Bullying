            ...
            <div class="card" style="border: none; border-radius: 16px; box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08); overflow: hidden;">
                ...
                <div style="background: linear-gradient(135deg, #10b981, #059669); padding: 32px 24px;">
                    <div class="d-flex align-items-center" style="gap: 16px;">
                        ...
                        <div>
                            <h2 style="margin: 0; font-weight: 600; color: white; font-size: 28px;">Edit Data Selesai</h2>
                            <p style="margin: 8px 0 0 0; color: rgba(255,255,255,0.9); font-size: 14px;">Perbarui hasil dan evaluasi tindakan</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 32px;">
                    ...
                    <!-- Form untuk Edit Data Selesai -->
                    <form method="POST" action="{{ route('tindak-lanjut.update-selesai-edit', $tindakLanjut->id) }}" id="form-edit-selesai">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="date" name="tanggal_selesai" class="form-control form-control-lg @error('tanggal_selesai') is-invalid @enderror" required value="{{ old('tanggal_selesai', $tindakLanjut->tanggal_selesai?->format('Y-m-d')) }}" style="border: 1px solid #ddd; border-radius: 8px; padding: 12px 16px;">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="hasil" class="form-control @error('hasil') is-invalid @enderror" rows="5" required placeholder="Jelaskan hasil dari tindakan yang telah dilakukan secara detail..." style="border: 1px solid #ddd; border-radius: 8px; padding: 12px 16px; font-size: 14px;">{{ old('hasil', $tindakLanjut->hasil) }}</textarea>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="evaluasi" class="form-control @error('evaluasi') is-invalid @enderror" rows="4" placeholder="Berikan evaluasi terhadap tindakan yang telah dilakukan..." style="border: 1px solid #ddd; border-radius: 8px; padding: 12px 16px; font-size: 14px;">{{ old('evaluasi', $tindakLanjut->evaluasi) }}</textarea>
                        ...
                        <!-- Status Hasil - Dropdown Style (Sinkron dengan selesai.blade.php) -->
                        <div class="form-group mb-4">
                            ...
                            <select name="status_hasil" class="form-select @error('status_hasil') is-invalid @enderror" required style="border: 1px solid #ddd; border-radius: 8px; padding: 12px 16px; font-size: 14px; width: 100%; display: block;">
                                ...
                                <option value="berhasil" {{ old('status_hasil', $tindakLanjut->status_hasil) == 'berhasil' ? 'selected' : '' }}>✓ Berhasil - Tindakan berhasil sepenuhnya</option>
                                <option value="cukup_berhasil" {{ old('status_hasil', $tindakLanjut->status_hasil) == 'cukup_berhasil' ? 'selected' : '' }}>✓ Cukup Berhasil - Ada hasil tapi perlu perbaikan</option>
                                <option value="perlu_tindak_lanjut" {{ old('status_hasil', $tindakLanjut->status_hasil) == 'perlu_tindak_lanjut' ? 'selected' : '' }}>⟳ Perlu Tindak Lanjut - Perlu tindakan tambahan</option>
                            </select>
                            @error('status_hasil') 
                    ...
                    <div class="row g-3">
                        <!-- Button Kembali -->
                        <div class="col-md-6">
                            <a href="{{ route('tindak-lanjut.index') }}" class="btn btn-lg w-100" style="border: 1px solid #6b7280; color: #6b7280; background: white; border-radius: 10px; font-weight: 600; text-decoration: none; padding: 12px;">
                        ...
                        <div class="col-md-6">
                            <button type="submit" form="form-edit-selesai" class="btn btn-lg w-100" style="background: linear-gradient(135deg, #10b981, #059669); color: white; border: none; border-radius: 10px; font-weight: 600; padding: 12px;">
